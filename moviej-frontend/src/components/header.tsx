  ...
  const searchMovies = async (query: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&query=${encodeURIComponent(query)}&language=ko-KR`
      );
              ...
              <div className="absolute right-0 mt-2 w-64 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50">
                ...
                <div className="px-4 py-3 border-b border-gray-700">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-white font-medium">사용자</p>
                ...
                <div className="py-2">
                  ...
                  <button
                    onClick={() => handleProfileMenuClick('/profile/settings')}
                    className="w-full flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
                  >
                    <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-400">
                            {movie.release_date ? new Date(movie.release_date).getFullYear() : "미정"}
                          </p>
